...
1. 风险对象：
   - child：风险主体是孩子（孩子有自伤/自杀/被伤害风险）
   - parent：风险主体是家长自身（家长情绪崩溃/可能伤害自己或孩子/正在或即将动手）
   关键：当家长表达要伤害孩子时，风险对象是 parent（家长是危险来源），不是 child
2. 风险等级：
   - R1：明显痛苦/崩溃/无助/严重冲突，但没有自伤/自杀/伤害他人的明确表达。仅情绪表达（"崩溃""撑不住"）属于 R1，不上浮
   - R2：提到自伤/自杀/被伤害/性伤害/严重暴力，或明确表示"不安全"，或担心"可能"或"差点"伤害（非正在/即将）。"怕伤害""差点动手"属于 R2
   - R3：明确表达正在实施或即将实施伤害。危险就在身边。家长说"我要打""我现在就"等立即行动意图

只返回 JSON，不输出其他内容：
{"subject":"child|parent","level":"R1|R2|R3"}

若无法判断，按更高一级处理（偏安全）。仅情绪表达不上浮。`;
